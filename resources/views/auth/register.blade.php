		...
		<div class="form-v2-content">
			<form class="form-detail" action="{{route('register')}}" method="post" id="myform" style="width: 100%;">
				...
				<div class="form-row">
					...
					<input type="nama" name="nama" id="nama" class="input-text" required>
				</div>
				<div class="form-row">
					<label for="instansi">Instansi :</label>
					<input type="instansi" name="instansi" id="instansi" class="input-text" required>
				</div>
				<div class="form-row">
					<label for="guru_pembimbing">Guru Pembimbing :</label>
					<input type="guru_pembimbing" name="guru_pembimbing" id="guru_pembimbing" class="input-text" required>
				</div>
				<div class="form-row">
